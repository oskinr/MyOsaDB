...
tk.Radiobutton(mode_frame, text="Старый режим", variable=mode_var, value="old").pack(side=tk.TOP)
tk.Radiobutton(mode_frame, text="Новый режим", variable=mode_var, value="new").pack(side=tk.TOP)

tk.Label(mode_frame, text="Выбрать отчет:").pack(side="left")
combo_type = ttk.Combobox(mode_frame, values=["01.03.07", "01.03.11","01.07.08"], state="readonly", width=10)
combo_type.pack(side="left", padx=8)
